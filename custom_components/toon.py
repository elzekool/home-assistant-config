...
CONF_GAS = 'gas'
CONF_SOLAR = 'solar'
CONF_TOON_CONSUMER_KEY = 'consumer_key'
CONF_TOON_CONSUMER_SECRET = 'consumer_secret'
...
CONFIG_SCHEMA = vol.Schema({
    DOMAIN: vol.Schema({
        ...
        vol.Required(CONF_TOON_CONSUMER_KEY): cv.string,
        vol.Required(CONF_TOON_CONSUMER_SECRET): cv.string,
...
def setup(hass, config):
    ...
    consumer_key = config[DOMAIN][CONF_TOON_CONSUMER_KEY]
    consumer_secret = config[DOMAIN][CONF_TOON_CONSUMER_SECRET]

    try:
        hass.data[TOON_HANDLE] = ToonDataStore(username, password, consumer_key, consumer_secret, gas, solar)
...
class ToonDataStore:
    ...
    def __init__(self, username, password, consumer_key, consumer_secret, gas=DEFAULT_GAS,
                 solar=DEFAULT_SOLAR):
        """Initialize Toon."""
